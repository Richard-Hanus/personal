...
if [ -x /usr/bin/apt-get ]; then
  ...
  sed -i 's/Server=127.0.0.1/Server=10.0.1.20/' /etc/zabbix/zabbix_agentd.conf
  sed -i 's/ServerActive=127.0.0.1/ServerActive=10.0.1.20/' /etc/zabbix/zabbix_agentd.conf
